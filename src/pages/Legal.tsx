...
export default function Legal() {
  ...
  const { data: nav } = useApi(() => api.listLegal(), []);
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <QueryStatus loading={loading || !policy} error={null}>
        {policy ? (
          <>
            ...
            <div className="grid items-start gap-8 lg:grid-cols-[17rem_minmax(0,1fr)] lg:gap-12">
              ...
              <article>
                ...
                <div className="mt-8 space-y-5">
                  {(policy.sections ?? []).map((section, i) => (
                    <section key={section.heading} id={sectionId(section.heading)} className="card scroll-mt-24 p-6 sm:p-8">
